...
const AvisUsers = () => {
  return (
    <div className=" py-10  text-center mt-8 mb-10">
<div className="mx-auto my-8 flex w-full items-center justify-evenly before:mr-4 before:block before:h-px before:flex-grow before:bg-stone-400 after:ml-4 after:block after:h-px after:flex-grow after:bg-stone-400">
        <h1 className="text-4xl font-bold text-center">Avis Clients</h1>
      </div>    
        <div className="carousel rounded-box py-16 w-[700px]  gap-6  p text-center">
        <div className="carousel-item ">
          <div className="bg-white p-4 shadow-lg  rounded-lg">
          <figure className="w-44 h-70 flex flex-col justify-between max-w-screen-md">
    ...
    <blockquote>
        <p className="text-1xl font-semibold text-gray-900 dark:text-white">"Flowbite is just awesome. It contains tons of predesigned components and pages starting from login screen to complex dashboard. Perfect choice for your next SaaS application."</p>
    </blockquote>
    <figcaption className="flex items-center mt-6 space-x-3 rtl:space-x-reverse">
        ...
        <div className="flex items-center divide-x-2 rtl:divide-x-reverse divide-gray-300 dark:divide-gray-700">
            ...
            <cite className="ps-3 text-sm text-gray-500 dark:text-gray-400">CTO at Flowbite</cite>
        </div>
    </figcaption>
</figure>
